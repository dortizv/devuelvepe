...
<div class="container-fluid m-0 p-0">
    ...
    <div class="row m-auto py-2 justify-content-center topbar" id="top-bar">
        ...
        <div class="col" id="cont-central">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <a class="align-content-center" href="./clientes.php">
                    <div class="col-auto text-center justify-content-center pt-4 mx-4 mb-4 primary-buttons transition">
                ...
                <!-- Botón Historial -->
                <div href="" class="col-auto text-center justify-content-center pt-4 mx-4 mb-4 primary-buttons transition">
                    <div class="figure align-middle">
