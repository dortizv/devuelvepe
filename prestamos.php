...
<html lang="es">
    ...
    <div class="struct" id="editar">
        <div class="prompt">
            ...
            <div class="container">
                ...
                <form action="./editar-prestamo/edit.php" method = "POST">
                
                <!-- campo id -->
                    <div class="inputId">
                        <input class = ""type="number" readonly="readonly" class="form-control" id="idPrestamoEdit" name="idPrestamoEdit" style = "float: right; text-align: right; border: 1px solid whitesmoke;color:whitesmoke; background-color: whitesmoke; width:10px;">
                </div>
    
                <!-- campo cliente -->
                <div class="mb-3">
                    <label for="clienteEdit" style="font-family: Raleway; font-weight: 600; font-size: 16px">Cliente:</label>
                    <input type="text" readonly class="form-control" id="clienteEdit" name="clienteEdit" required style="background-color: whitesmoke">
                </div>
                
                <!-- campo cobrador -->
                <div class="mb-3">
                    <label for="cobradorEdit" style="font-family: Raleway; font-weight: 600; font-size: 16px">Cobrador:</label>
                    <input type="text" readonly class="form-control" id="cobradorEdit" name="cobradorEdit" required style="background-color: whitesmoke">
                </div>
                
                <!-- campo monto -->
                <div class="mb-3">
                    <label for="montoEdit" style="font-family: Raleway; font-weight: 600; font-size: 16px">Monto (S/):</label>
                    <input type="number" class="form-control" id="montoEdit" name="montoEdit" required>
                </div>
                
                <!-- campo tasa -->
                <div class="mb-3">
                    <label for="tasaEdit" style="font-family: Raleway; font-weight: 600; font-size: 16px">Tasa (%):</label>
                    <input type="number" class="form-control" id="tasaEdit" name="tasaEdit" required>
                </div>

                <!-- campo cuotas -->
                <div class="mb-3">
                    <label for="cuotasEdit" style="font-family: Raleway; font-weight: 600; font-size: 16px">Número de cuotas:</label>
                    <input type="number" class="form-control" id="cuotasEdit" name="cuotasEdit" required>
                </div>

                <button type="submit" class="mx-1 my-1" style="width: fit-content; padding: 5px 10px; border-radius: 5px; background-color: #2A9D8F; color: white; font-family: Raleway; font-weight: 600; font-size: 14px">Aceptar</button>
    ...
    <!--FIN TABLA DE INFORMACIÓN-->             
        ...
        function openDiveditar(idPrestamo, clienteNA, cobradorNA, monto, tasa, cuotas) {
            ...
            console.log('clienteNA:', clienteNA);
            console.log('cobradorNA:', cobradorNA);
        }
        </script>
